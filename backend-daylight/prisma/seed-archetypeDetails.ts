...
export async function seedArchetypeDetails() {
  ...
  const archetypes = [
    {
      ...
      description:
        'You bring fresh energy wherever you go.  The kind of person who starts the conversation — and the laughter. ',
    ...
    },
    {
      ...
      description:
        'You move at your own rhythm. People feel comfortable around you — grounded, kind, quietly confident.',
      imageKey: 'calm-dawn',
    },
    {
      ...
      description:
        'The go-getter of every table. You lead naturally, keep things on track, and turn ideas into plans.',
      imageKey: 'bold-noon',
    },
    {
      ...
      description:
        'You light up rooms with your stories and laughter.  Effortlessly social, you make everyone feel seen. ',
    ...
    },
    {
      ...
      description:
        "You're the thinker who listens before you speak — insightful, calm, and full of perspective.",
      imageKey: 'quiet-dusk',
    },
    {
      ...
      description:
        'You see beauty in small moments. Often reserved, but when you open up, your words hit deep.',
      imageKey: 'cloudy-day',
    },
    {
      ...
      description:
        "You don't chase attention — you create peace. You're the steady soul who listens and understands.",
    ...
    },
    {
      ...
      description:
        'You bring heat and direction.  When others hesitate, you move — pure action and confidence.',
    ...
    },
    {
      ...
      description:
        'You live in ideas and imagination. You connect through stories, purpose, and shared curiosity.',
    ...
    },
    {
      ...
      description:
        "You flow between energies with grace — social when needed, quiet when it counts.  You're harmony itself.",
