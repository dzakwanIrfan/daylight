...
import { Loader2, Users, RefreshCw, Eye, AlertCircle, History, Info } from 'lucide-react';
        ...
        <div className="p-6 space-y-4">
          ...
          <Alert className="border-blue-200 bg-blue-50">
            ...
            <AlertDescription className="text-sm text-blue-900">
              Multi-pass algorithm tries thresholds from 70% down to 0% with 10 seed attempts per level. 
              All results are saved for transparency.
            </AlertDescription>
          </Alert>
        </div>
      </Card>
