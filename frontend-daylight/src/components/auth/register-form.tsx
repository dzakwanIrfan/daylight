    ...
    <div className="relative w-full h-full space-y-8 flex flex-col md:flex-row p-4 md:p-0">
      ...
      <div className="flex flex-col py-10 md:p-10 w-full md:w-1/3">
        <div className="text-center md:text-left flex flex-col">
          ...
          <p className="">
            You've completed the light persona quiz. Unlock the result, by sign
            up!
          </p>
        </div>
      ...
      <div className="w-full md:w-2/3 px-3 lg:px-64 py-12 lg:py-1 border-2 border-orange-400 rounded-2xl md:rounded-l-2xl space-y-8 lg:h-screen bg-white/30 backdrop-blur-lg inset-shadow-sm inset-shadow-white">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="John"
                {...register("firstName")}
                className={`rounded-full px-6 py-4 bg-white! text-gray-800 placeholder:text-gray-500 shadow-[0_6px_12px_rgba(0,0,0,0.08)] border border-white focus:outline-none focus:ring-2 focus:ring-[#f2ac55] {errors.firstName ? "border-destructive" : ""}`}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Doe"
                {...register("lastName")}
                className={`rounded-full px-6 py-4 bg-white! text-gray-800 placeholder:text-gray-500 shadow-[0_6px_12px_rgba(0,0,0,0.08)] border border-white focus:outline-none focus:ring-2 focus:ring-[#f2ac55] {errors.lastName ? "border-destructive" : ""}`}
                disabled={registerMutation.isPending}
              />
              {errors.lastName && (
                <p className="text-sm text-destructive">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="px-2 text-muted-foreground">Or register with</span>
          </div>
        </div>
